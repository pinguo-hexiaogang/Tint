...
public abstract class AnimationDrawableCallback implements Drawable.Callback {
     ...
     * @param callback          the client's {@link Drawable.Callback} implementation. This is usually the {@link View} the has the
    ...
    /**
     * Callback triggered when  has been called on the last frame, which marks
